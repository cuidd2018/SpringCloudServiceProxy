...
public class TestJobMono {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < InvkeCountTest.MaxCount; i++) {
            executorService.execute(new TestJobMono.CustomRunnable(i));
        }
    }
        ...
        public void run() {
           ...
           // System.out.println("===================="+s+"======================");
            ...
            if(index==InvkeCountTest.MaxCount){
                System.out.println(TestJobMono.class.getSimpleName()+":"+(new Date().getTime()-date.getTime())+"ms ================================================");
            }else {
